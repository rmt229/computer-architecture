...
def test_addi_rand_delays( dump_vcd ):
  run_test( ProcAltRTL, inst_staff_addi.gen_random_test, dump_vcd,
...
def test_andi_rand_delays( dump_vcd ):
  run_test( ProcAltRTL, inst_staff_andi.gen_random_test, dump_vcd,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_ori_rand_delays( dump_vcd ):
  run_test( ProcAltRTL, inst_staff_ori.gen_random_test, dump_vcd,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_xori_rand_delays( dump_vcd ):
  run_test( ProcAltRTL, inst_staff_xori.gen_random_test, dump_vcd,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_slti_rand_delays( dump_vcd ):
  run_test( ProcAltRTL, inst_staff_slti.gen_random_test, dump_vcd,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_sltiu_rand_delays( dump_vcd ):
  run_test( ProcAltRTL, inst_staff_sltiu.gen_random_test, dump_vcd,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_srai_rand_delays( dump_vcd ):
  run_test( ProcAltRTL, inst_staff_srai.gen_random_test, dump_vcd,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_srli_rand_delays( dump_vcd ):
  run_test( ProcAltRTL, inst_staff_srli.gen_random_test, dump_vcd,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_slli_rand_delays( dump_vcd ):
  run_test( ProcAltRTL, inst_staff_slli.gen_random_test, dump_vcd,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_lui_rand_delays( dump_vcd ):
  run_test( ProcAltRTL, inst_staff_lui.gen_random_test, dump_vcd,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_auipc_rand_delays( dump_vcd ):
  run_test( ProcAltRTL, inst_staff_auipc.gen_random_test, dump_vcd,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
