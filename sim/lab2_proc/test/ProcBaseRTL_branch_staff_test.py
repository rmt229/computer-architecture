...
def test_beq_rand_delays( dump_vcd ):
  run_test( ProcBaseRTL, inst_staff_beq.gen_random_test, dump_vcd,
...
def test_bne_rand_delays( dump_vcd ):
  run_test( ProcBaseRTL, inst_staff_bne.gen_random_test, dump_vcd,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3)
...
def test_bge_rand_delays( dump_vcd ):
  run_test( ProcBaseRTL, inst_staff_bge.gen_random_test, dump_vcd,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3)
...
def test_bgeu_rand_delays( dump_vcd ):
  run_test( ProcBaseRTL, inst_staff_bgeu.gen_random_test, dump_vcd,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3)
...
def test_blt_rand_delays( dump_vcd ):
  run_test( ProcBaseRTL, inst_staff_blt.gen_random_test, dump_vcd,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3)
...
def test_bltu_rand_delays( dump_vcd ):
  run_test( ProcBaseRTL, inst_staff_bltu.gen_random_test, dump_vcd,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3)
