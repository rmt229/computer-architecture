...
def test_add_rand_delays( dump_vcd ):
  run_test( ProcBaseRTL, inst_staff_add.gen_random_test, dump_vcd,
...
def test_sub_rand_delays( dump_vcd ):
  run_test( ProcBaseRTL, inst_staff_sub.gen_random_test, dump_vcd,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_mul_rand_delays( dump_vcd ):
  run_test( ProcBaseRTL, inst_staff_mul.gen_random_test, dump_vcd,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_and_rand_delays( dump_vcd ):
  run_test( ProcBaseRTL, inst_staff_and.gen_random_test, dump_vcd,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_or_rand_delays( dump_vcd ):
  run_test( ProcBaseRTL, inst_staff_or.gen_random_test, dump_vcd,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_xor_rand_delays( dump_vcd ):
  run_test( ProcBaseRTL, inst_staff_xor.gen_random_test, dump_vcd,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_slt_rand_delays( dump_vcd ):
  run_test( ProcBaseRTL, inst_staff_slt.gen_random_test, dump_vcd,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_sltu_rand_delays( dump_vcd ):
  run_test( ProcBaseRTL, inst_staff_sltu.gen_random_test, dump_vcd,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_sra_rand_delays( dump_vcd ):
  run_test( ProcBaseRTL, inst_staff_sra.gen_random_test, dump_vcd,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_srl_rand_delays( dump_vcd ):
  run_test( ProcBaseRTL, inst_staff_srl.gen_random_test, dump_vcd,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_sll_rand_delays( dump_vcd ):
  run_test( ProcBaseRTL, inst_staff_sll.gen_random_test, dump_vcd,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
