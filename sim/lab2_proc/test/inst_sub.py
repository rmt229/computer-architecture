...
def gen_value_test():
  return [
    ...
    # gen_rr_value_test( "sub", 0x80000000, 0xffff8000, 0x7fff8000 ),

    gen_rr_value_test( "sub", 0x7fffffff, 0x00000000, 0x7fffffff ),
    # gen_rr_value_test( "sub", 0x7fffffff, 0x00007fff, 0x80007ffe ),

    # gen_rr_value_test( "sub", 0x80000000, 0x00007fff, 0x80007fff ),
    # gen_rr_value_test( "sub", 0x7fffffff, 0xffff8000, 0x7fff7fff ),

    gen_rr_value_test( "sub", 0xffffffff, 0x00000000, 0xffffffff ),
    # gen_rr_value_test( "sub", 0xffffffff, 0x00000001, 0x00000000 ),
