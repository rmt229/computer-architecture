//======================================================================
// VAluVRTL_0x1e74d35e4f1f6285_v.cpp
//======================================================================
// This wrapper exposes a C interface to CFFI so that a
// Verilator-generated C++ model can be driven from Python.
//

#include "obj_dir_AluVRTL_0x1e74d35e4f1f6285/VAluVRTL_0x1e74d35e4f1f6285.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_AluVRTL_0x1e74d35e4f1f6285/VAluVRTL_0x1e74d35e4f1f6285__Syms.h"
#include "svdpi.h"
#endif
...
VAluVRTL_0x1e74d35e4f1f6285_t * create_model( const char *vcd_filename ) {

  VAluVRTL_0x1e74d35e4f1f6285_t * m;
  VAluVRTL_0x1e74d35e4f1f6285   * model;

  Verilated::randReset( 0 );

  m     = (VAluVRTL_0x1e74d35e4f1f6285_t *) malloc( sizeof(VAluVRTL_0x1e74d35e4f1f6285_t) );
  model = new VAluVRTL_0x1e74d35e4f1f6285();
  ...
  m->reset = &model->reset;
  m->clk = &model->clk;
  m->ops_ltu = &model->ops_ltu;
  m->ops_lt = &model->ops_lt;
  m->ops_eq = &model->ops_eq;
  m->out = &model->out;
...
void destroy_model( VAluVRTL_0x1e74d35e4f1f6285_t * m ) {

  VAluVRTL_0x1e74d35e4f1f6285 * model = (VAluVRTL_0x1e74d35e4f1f6285 *) m->model;
...
void eval( VAluVRTL_0x1e74d35e4f1f6285_t * m ) {
...
#if VLINETRACE
void trace( VAluVRTL_0x1e74d35e4f1f6285_t * m, char* str ) {
