...
def gen_srcs_dest_test():
  return [
    gen_rr_src0_eq_dest_test( "sltu", 0x00000004, 0x00000002, 0x00000000 ),
    gen_rr_src1_eq_dest_test( "sltu", 0x0000f000, 0xf0000000, 0x00000001 ),
    gen_rr_src0_eq_src1_test( "sltu", 0x00000004, 0x00000000 ),
    gen_rr_srcs_eq_dest_test( "sltu", 0xf0000000, 0x00000000 ),
  ]
